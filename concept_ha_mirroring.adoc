...
Un cluster a due nodi con un mediatore può estendersi su due data center. Per ulteriori informazioni, consultare la sezione link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["Buone pratiche per HA esteso a due nodi (MetroCluster SDS)"] .
