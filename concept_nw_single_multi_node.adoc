...
Per i dettagli, vedere la sezione link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["Buone pratiche per HA esteso a due nodi (MetroCluster SDS)"] .
