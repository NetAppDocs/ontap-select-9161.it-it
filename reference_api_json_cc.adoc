...
summary: 'Quando si crea o si elimina un cluster ONTAP Select utilizzando gli esempi di codice Python, è necessario fornire un file JSON come input per lo script. È possibile copiare e modificare l"esempio JSON appropriato in base ai propri piani di distribuzione.' 
---
