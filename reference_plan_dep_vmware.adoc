...
Sia l'utility di amministrazione Deploy che i nodi ONTAP Select vengono eseguiti come macchine virtuali. L'hypervisor scelto per l'utility Deploy è indipendente da quello scelto per i nodi ONTAP Select . L'abbinamento dei due offre la massima flessibilità:
