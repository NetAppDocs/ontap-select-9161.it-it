...
* link:task_cli_migrate_deploy.html#restore-the-deploy-configuration-data-to-the-new-virtual-machine["Ripristinare i dati di configurazione di distribuzione sulla nuova macchina virtuale"]
* link:task_adm_licenses.html#reinstall-a-capacity-pool-license["Reinstallare una licenza Capacity Pool"]
