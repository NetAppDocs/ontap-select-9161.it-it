...
== Installa una nuova istanza della macchina virtuale Deploy
...
== Ripristinare i dati di configurazione di distribuzione sulla nuova macchina virtuale
...
.Passi
. In una shell dei comandi sulla workstation locale, utilizzare l'utilità sftp per caricare il file di backup sulla macchina virtuale Deploy.
+
Esempio
